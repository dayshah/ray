...
class GcsFunctionManager {
 ...
 private:
  void RemoveExportedFunctions(const JobID &job_id) {
    ...
    kv_.DelByPrefix("fun", "RemoteFunction:" + job_id_hex + ":", [](auto) {});
    kv_.DelByPrefix("fun", "ActorClass:" + job_id_hex + ":", [](auto) {});
    kv_.DelByPrefix(
        "fun", absl::StrCat(kWorkerSetupHookKeyName, ":", job_id_hex, ":"), [](auto) {});
  }
